...
public class ViewDragHelper {
    ...
    private final Runnable mSetIdleRunnable = new Runnable() {
        public void run() {
//            Log.e("test","mSetIdleRunnable STATE_IDLE");
...
//        Log.e("test","captureChildView STATE_DRAGGING");
...
//        Log.e("test","cancel()");
    ...
    private boolean forceSettleCapturedViewAt(int finalLeft, int finalTop, int xvel, int yvel) {
        ...
        if (dx == 0 && dy == 0) {
            ...
            mScroller.abortAnimation();
//            Log.e("test","forceSettleCapturedViewAt STATE_IDLE");
            setDragState(STATE_IDLE);
            return false;
        }
...
//        Log.e("test","forceSettleCapturedViewAt STATE_SETTLING");
    ...
    public boolean continueSettling(boolean deferCallbacks) {
        if (mDragState == STATE_SETTLING) {
            ...
            if (!keepGoing) {
                if (deferCallbacks) {
//                    Log.e("test","continueSettling mSetIdleRunnable");
                    mParentView.post(mSetIdleRunnable);
                } else {
//                    Log.e("test","continueSettling STATE_IDLE");
                    setDragState(STATE_IDLE);
                }
            }
        }

//        Log.e("test"," continueSettling mDragState  === STATE_SETTLING"+ mDragState);
...
//                Log.e("test","action_down"+"++"+mCapturedView+"+++mDragState"+mDragState);
                // Catch a settling view if possible.
                if (toCapture == mCapturedView && mDragState == STATE_SETTLING) {

//                    Log.e("test","action_down"+"++ 进了条件");
...
//                    Log.e("test","pastSlop"+pastSlop+"+++"+"checkTouchSlop"+checkTouchSlop(toCapture, dx, dy));
                    if (pastSlop) {
...
//                            Log.e("test","i am break "+"+++verticalDragRange"+verticalDragRange+"+++"+newTop+"+++newTop++"+oldTop+"+++oldTop");
                            break;
                        }
                    }
                    reportNewEdgeDrags(dx, dy, pointerId);
//                    Log.e("test","mDragState"+ mDragState);
                    if (mDragState == STATE_DRAGGING) {
...
//        Log.e("test","dy"+Math.abs(dy) +"+++"+mTouchSlop);
        if (child == null) {
            return false;
        }
...
//        Log.e("test","checkHorizontal"+checkHorizontal+"++checkVertical"+checkVertical);
        if (checkHorizontal && checkVertical) {
            return dx * dx + dy * dy > mTouchSlop * mTouchSlop;
        } else if (checkHorizontal) {
            return Math.abs(dx) > mTouchSlop;
        } else if (checkVertical) {
//            Log.e("test","dy"+Math.abs(dy));
